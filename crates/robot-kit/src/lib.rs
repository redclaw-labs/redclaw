//! # RedClaw Robot Kit
//!
//! A standalone robotics toolkit that integrates with RedClaw for AI-powered robots.
//!
//! ## Features
//!
...
//! ```text
//! ┌─────────────────────────────────────────────────────────┐
//! │  RedClaw AI Brain (or any controller)                  │
...
//!
//! ```rust,ignore
//! use redclaw_robot_kit::{RobotConfig, DriveTool, SafetyMonitor, SafeDrive};
//! use std::sync::Arc;
//!
//! #[tokio::main]
//! async fn main() {
...
//! ## Standalone Usage
//!
//! This crate can be used independently of RedClaw. It defines its own
//! `Tool` trait that is compatible with RedClaw's but doesn't require it.
//!
//! ## Safety
//!
