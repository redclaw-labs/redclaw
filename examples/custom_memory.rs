//! Example: Implementing a custom Memory backend for RedClaw
//!
...
// ── Re-define the trait types (in your app, import from redclaw::memory) ──
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("🧠 RedClaw Memory Demo — InMemoryBackend\n");
