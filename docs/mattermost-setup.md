...
RedClaw automatically supports Mattermost threads. 
- If a user sends a message in a thread, RedClaw will reply within that same thread.
- If a user sends a top-level message, RedClaw will start a thread by replying to that post.
