...
- [x] `redclaw-esp32` firmware crate (`firmware/redclaw-esp32`) — GPIO over UART
...
**Usage:** Flash `firmware/redclaw-esp32` to ESP32, add `board = "esp32"`, `transport = "serial"`, `path = "/dev/ttyUSB0"` to config.
