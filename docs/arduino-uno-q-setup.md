...
|-----------|----------|---------|
| Bridge app | `firmware/redclaw-uno-q-bridge/` | MCU sketch + Python socket server (port 9999) for GPIO |
...
This copies the Bridge app to `~/ArduinoApps/redclaw-uno-q-bridge` and starts it.
