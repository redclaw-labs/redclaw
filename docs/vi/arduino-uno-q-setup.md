...
|------------|--------|---------|
| Bridge app | `firmware/redclaw-uno-q-bridge/` | MCU sketch + Python socket server (port 9999) cho GPIO |
...
git clone https://github.com/redf0x1/redclaw.git
cd redclaw
...
Lệnh này copy Bridge app vào `~/ArduinoApps/redclaw-uno-q-bridge` và khởi động nó.
...
| 5 | `git clone https://github.com/redf0x1/redclaw.git && cd redclaw` |
