...
- [x] Crate firmware `redclaw-esp32` (`firmware/redclaw-esp32`) — GPIO qua UART
...
**Cách dùng:** Nạp `firmware/redclaw-esp32` vào ESP32, thêm `board = "esp32"`, `transport = "serial"`, `path = "/dev/ttyUSB0"` vào config.
