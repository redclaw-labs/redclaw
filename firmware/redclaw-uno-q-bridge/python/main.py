# RedClaw Bridge — socket server for full MCU peripheral control
...
def main():
    ...
    server.bind(("0.0.0.0", REDCLAW_PORT))
    server.listen(5)
    server.settimeout(1.0)
    print(f"[RedClaw Bridge] Listening on 0.0.0.0:{REDCLAW_PORT}", flush=True)
