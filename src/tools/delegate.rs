...
mod tests {
    ...
    impl Tool for EchoTool {
        ...
        fn description(&self) -> &str {
            "Echo a string for deterministic tests"
        }
            ...
            if call_index == 0 {
                return Ok(ChatResponse {
                    ...
                    tool_calls: vec![ToolCall {
                        ...
                        arguments: serde_json::json!({"value": "done"}).to_string(),
                    }],
                });
            }
    ...
    impl Provider for InfiniteToolCallProvider {
        ...
        async fn chat(
            ...
            Ok(ChatResponse {
                text: None,
                tool_calls: vec![ToolCall {
                    id: "toolcall-infinite".to_string(),
                    name: "echo_tool".to_string(),
                    arguments: serde_json::json!({"value": "loop"}).to_string(),
                }],
            })
        }
    }
    ...
    async fn execute_agentic_runs_tool_call_loop_with_filtered_tools() {
        ...
        let provider = OneToolThenFinalProvider::new();
        let result = tool
