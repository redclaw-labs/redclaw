...
impl ComposioTool {
    ...
    fn build_execute_action_v3_request(
        ...
        if let Some(account_ref) = connected_account_ref
            .map(str::trim)
...
mod tests {
    ...
    fn resolve_picks_first_usable_when_multiple_accounts_exist() {
        // Regression test for issue #959: selection should pick the first usable.
    ...
    #[test]
    fn build_execute_action_v3_request_includes_user_and_account_when_provided() {
